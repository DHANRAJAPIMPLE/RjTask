        ...
        if (u.userMappings.length === 0) {
          ...
          result.inactiveUsers.push({
            basicDetails: {
              ...
              email: u.email,
              phone: u.phone,
              companyOnboardingDate: UserController.formatDate(u.createdAt),
              designation: 'N/A',
          ...
          u.userMappings.forEach((m: any) => {
            ...
            const userData = {
              basicDetails: {
                ...
                email: u.email,
                phone: u.phone,
                companyOnboardingDate: UserController.formatDate(m.createdAt),
      ...
      pendingOnboardings.forEach((onb: any) => {
        ...
        result.pendingUsers.push({
          ...
          basicDetails: {
            ...
            companyOnboardingDate: UserController.formatDate(onb.createdAt),
