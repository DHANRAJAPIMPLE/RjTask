...
router.post('/company/update-status', OnboardingDbController.updateCompanyOnboardingStatus);
router.post('/company/approve-commit', OnboardingDbController.approveCompanyOnboarding);
...
router.post('/user/update-status', OnboardingDbController.updateUserOnboardingStatus);
router.post('/user/approve-commit', OnboardingDbController.approveUserOnboarding);
