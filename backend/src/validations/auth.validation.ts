...
// Logic: Schema for login — includes 'system' flag for force-login logic
export const loginSchema = z.object({
  body: z.object({
    ...
    system: z
      ...
      .refine((val) => val === 0 || val === 1, {
        message: "System must be 0 (normal) or 1 (force login)",
      })
      .default(0),
  ...
  .refine(
    ...
    {
      message: "force_log_token is required when system = 1",
